...
using sse8 = fqhex::hex8_ssse3<char, std::byte>;
using sse16 = fqhex::hex16_ssse3<char16_t, std::byte>;
using sse32 = fqhex::hex32_ssse3<char32_t, std::byte>;
using avx8 = fqhex::hex8_avx2<char, std::byte>;
using avx16 = fqhex::hex16_avx2<char16_t, std::byte>;
using avx32 = fqhex::hex32_avx2<char32_t, std::byte>;
